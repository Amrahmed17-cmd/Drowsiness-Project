"""
generate_alert.py — run once to create assets/alert.wav
Usage: python scripts/generate_alert.py
"""
...
for i in range(n):
    t = i / RATE
    fade = min(1.0, min(t / 0.02, (DURATION - t) / 0.05))   # 20ms attack, 50ms release
